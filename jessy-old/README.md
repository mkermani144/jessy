...
Archived Rust implementation.

The repo root has pivoted to the Claude Code skill/plugin implementation in
`../plugin/`. This directory preserves the previous Rust workspace, docs,
config examples, migrations, and runtime artifacts for reference.
