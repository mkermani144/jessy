...
30. `bash plugin/scripts/db_stage.sh run_create` prints a compact JSON
    receipt with `run_id`.
31. Snapshot helpers persist payload text but stdout receipts contain only ids
    and counts.
